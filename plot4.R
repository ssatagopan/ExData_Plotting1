...
par(mfrow = c(2,2))
with(dfPowCons, plot(Global_active_power,type = "l", ylab = "Global Active Power", xaxt = "n", xlab = ""))
axis(side=1, at=c(1,1440,2880), labels = c("Thu","Fri","Sat"))
with(dfPowCons, plot(Voltage,type = "l", ylab = "Voltage", xaxt = "n", xlab = "datetime"))
axis(side=1, at=c(1,1440,2880), labels = c("Thu","Fri","Sat"))
...
with(dfPowCons, plot(Global_reactive_power,type = "l", ylab = "Global_reactive_power", xaxt = "n", xlab = "datetime"))
axis(side=1, at=c(1,1440,2880), labels = c("Thu","Fri","Sat"))
dev.off()
remove(dfPowCons)